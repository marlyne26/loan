                    ...
                    <form action="javascript:;" id="signup-form">
                        ...
                        <div class="form-group mb-3">
                            <div class="input-group input-group-alternative">
                                ...
                                <input class="form-control" placeholder="Student Name" type="text" id="name" required>
                            </div>
                        </div>
                        <div class="form-group mb-3">
                            <div class="input-group input-group-alternative">
                        ...
                        <div class="form-group mb-3">
                            <div class="input-group input-group-alternative">
                                ...
                                <input class="form-control" placeholder="Mobile No" type="number" id="mobileno" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group input-group-alternative">
                                ...
                                <input class="form-control" placeholder="Date of Birth" type="date" id="dob" required>
                            </div>
                        </div>
                ...
                <div class="overlay-container">
                    <div class="overlay">
                        ...
                        <div class="overlay-panel overlay-right">
                            <h1 class="text-white h2">Welcome to PrayagEdu</h1>
                            <p>Enter your details and start journey with us</p>
                             <button class="btn btn-neutral btn-sm" id="signUp">Register</button>
                        </div>
                    </div>
                </div>
            </div>
