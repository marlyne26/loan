...
<script src="assets/admin/plugins/daterangepicker/moment.min.js"></script>
...
<div class="content-wrapper" style="padding-bottom:0px !important;">
  ...
  <div class="content-header">
    <!-- <div class="row" style="position:absolute; top:128px; right:12px;">
  ...
  <section class="content" style="padding:4rem 0.5rem 1rem 0.5rem ;">
    <div class="container-fluid">
      <div class="row">
        <div class="container">

          <div class="col-md-12">
            <div class="card" style="background:linear-gradient(89deg, rgba(212, 98, 73, 1) 0%, rgba(175, 64, 97, 1) 53%, rgba(106, 16, 84, 1) 100%);">
              <div class="card-body">

                <div style="display:flex !important; float:right;">
                  <div style="flex-grow:1 !important;">
                    <button type="button" data-toggle="modal" data-target="#mdlSavePhoto" id="btnSavePhoto" class="btn btn-outline-danger btn-sm btnEdit no-media text-white" title="SAVE NEW PHOTO"><i class="fas fa-camera"></i></button>
                    <button type="button" data-toggle="modal" data-target="#mdlEditProfile" id="btnEditProfile" class="btn btn-outline-danger btn-sm btnEdit no-media text-white" title="EDIT PROFILE"><i class="fas fa-edit"></i></button>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-12" style="display:flex; align-items:center;">
                    <div>
                      <h4 id="v_name" class="text-white">-Staff Name-</h4>
                      <h5 id="v_designation" class="text-white">-Designation-</h2>
                      <h5 id="v_department" class="text-white"></h6>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-6 col-sm-12" style="display:flex; align-items:center;">
                    <ul class="fa-ul">
                      <li class="large">
                        ...
                        <span id="v_contactno" class="text-white">-Mobile Number-</span>
                      </li>
                      <li class="large">
                        <span class="fa-li text-white">
                          <i class="fa fa-envelope prefix"></i>
                        </span>
                        <span id="v_emailid" class="text-white">-Email ID-</span>
                      </li>
                      <li class="large">
                        <span class="fa-li text-white">
                          <i class="far fa-calendar-alt"></i>
                        </span>
                        <span class="text-white">Joined on <strong id="v_doj">DD/MM/YYYY</strong></span>
                      </li>
                      <li class="large">
                        <span class="fa-li text-white">
                          <i class="far fa-calendar-alt"></i>
                        </span>
                        <span class="text-white">Born on <strong id="v_dob">DD/MM/YYYY</strong></span>
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div style="display:flex !important; justify-content:space-around !important;">
                  <div>
                    <div class="description-block">
                      <h5 id="v_age" class="text-white text-center font-weight-bold">-</h5>
                      <h5 class="text-white text-center">AGE</h5>
                    </div>
                  </div>
                  <div>
                    <div class="description-block">
                      <h5 id="v_bloodgroup" class="text-white text-center font-weight-bold">-</h5>
                      <h5 class="text-white text-center">BLOOD GROUP</h5>
                    </div>
                  </div>
                  <div>
                    <div class="description-block">
                      <h5 id="v_yoe" class="text-white text-center font-weight-bold">-</h5>
                      <h5 class="text-white text-center">YEAR OF EXPERIENCE</h5>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="col-sm-12" id="div_additionaldetails_section">
            <div class="card">
              <div class="card-body" id="div_additionaldetails">
                <p class="card-title custom_card-title">MY ADDITIONAL DETAILS</p> <br> <br>
                <p >GENDER : <span id="v_gender" style="text-transform:capitalize !important; font-weight:600 !important;">-</span>&emsp; &emsp;RELIGION : <span id="v_religion" style="text-transform:capitalize !important; font-weight:600 !important;">-</span>&emsp; &emsp;CASTE : <span id="v_caste" style="text-transform:capitalize !important; font-weight:600 !important;">-</span>&emsp; &emsp;COMMUNITY : <span id="v_community" style="text-transform:capitalize !important; font-weight:600 !important;">-</span>&emsp; &emsp;NATIONALITY : <span id="v_nationality" style="text-transform:capitalize !important; font-weight:600 !important;">-</span>&emsp; &emsp;ADDRESS : <span id="v_address" style="text-transform:capitalize !important; font-weight:600 !important;">-</span></p>
              </div>
            </div>
          </div>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div style="display:flex !important;">
                  <p style="flex-grow:1 !important;" class="card-title custom_card-title">MY EDUCATION HISTORY</p>
                  <button class="btn btn-sm btn-outline-danger btnEdit no-media" data-toggle="modal" data-target="#mdlAddEducation" id="btnAddEducation" onclick="onResetAddEducation()" title="SAVE EDUCATION INFORMATION" type="button"><i class="fas fa-plus"></i></button>
                </div>
                
                <ul id="div_education" style="padding: 0 !important;">
          ...
          <div class="col-sm-12" id="div_iebd_section">
            <div class="card">
              <div class="card-body">
                ...
                <div style="display:flex !important;">
                  <p style="flex-grow:1 !important;" class="card-title custom_card-title">ASSOCIATION OF INTERNAL/EXTERNAL BODIES</p>
                  <button class="btn btn-sm btn-outline-danger btnEdit no-media" data-toggle="modal" data-target="#mdlAddIEBodyDetails" id="btnAddIEBodyDetails" onclick="onResetAddIEBodyDetails()" title="ADD INTERNAL/EXTERNAL BODY DETIALS" type="button"><i class="fas fa-plus"></i></button>
                </div>
          ...
          <div class="col-sm-12" id="div_family_section">
            <div class="card">
              <div class="card-body">
                ...
                <div style="display:flex !important;">
                  <p style="flex-grow:1 !important;" class="card-title custom_card-title">MY FAMILY MEMBERS</p>
                  <button class="btn btn-sm btn-outline-danger btnEdit no-media" data-toggle="modal" data-target="#mdlFamilyMember" id="btnFamilyMember" onclick="onResetFamilyMemberForm()" title="ADD FAMILY MEMBER / RELATIVE"><i class="fas fa-plus" type="button"></i></button>
                </div>

                <div class="row" id="div_family" style="padding-top:4px !important;">
          ...
          <div class="col-sm-12" id="div_work_section">
            <div class="card">
              <div class="card-body">
                ...
                <div style="display:flex !important;">
                  <p style="flex-grow:1 !important;" class="card-title custom_card-title">WORK DETAILS</p>
                  <button class="btn btn-sm btn-outline-danger btnEdit no-media" id="btnAddWorkDetails" onclick="onResetAddWorkDetails()" data-toggle="modal" data-target="#mdlAddWorkDetails" title="ADD WORK DETIALS" type="button"><i class="fas fa-plus"></i></button>
                </div>
          ...
          <div class="col-sm-12" id="div_vehicle_section">
            <div class="card">
              <div class="card-body">
                ...
                <div style="display:flex !important;">
                  <p style="flex-grow:1 !important;" class="card-title custom_card-title">MY VEHICLE(S)</p>
                  <button class="btn btn-sm btn-outline-danger btnEdit no-media" data-toggle="modal" data-target="#mdlAddVehicleInfo" id="btnAddVehicleInfo" onclick="onResetAddVehicleInfo();" title="ADD VEHICLE" type="button"><i class="fas fa-plus"></i></button>
                </div>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button type="button" id="btnCloseSavePhoto" class="btn btn-light" data-dismiss="modal" aria-label="Close">
        ...
        <div class="modal-body">
          <form id="frmPhoto">
            ...
            <div class="card-footer d-flex justify-content-between" style="margin-top:7px !important;">
    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button type="button" id="btnCloseEditProfile" class="btn btn-light" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button type="button" id="btnCloseAddEducation" class="btn btn-light" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <form id="frmAddEducationInformation">
            ...
            <div class="card-footer d-flex justify-content-between" style="margin-top:7px !important;">
              <button type="button" class=" btn btn-block btn-outline-secondary m-1 mt-2" onclick="onResetAddEducation()">RESET</button>
              <button type="submit" class="btn btn-block btn-danger">SUBMIT</button>
            </div>
          </form>
        </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="frmEditEducationInformation">
            ...
            <div class="card-footer d-flex justify-content-between" style="margin-top:7px !important;">
              <button type="button" class="btn btn-block btn-outline-secondary" onclick="onResetEditEducation()">RESET</button>
              <button type="submit" class="btn btn-block btn-danger">SUBMIT</button>
            </div>
          </form>
        </div>
    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button type="button" id="btnCloseAddIEBodyDetails" class="btn btn-light" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <form id="frmAddIEBodyDetails">
            ...
            <div class="card-footer d-flex justify-content-between" style="margin-top:7px !important;">
              <button type="button" class="btn btn-block btn-outline-secondary mt-2" onclick="onResetAddIEBodyDetails()">RESET</button>
              &nbsp; <button type="submit" class="btn btn-block btn-danger">SUBMIT</button>
            </div>
          </form>
        </div>
    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button type="button" id="btnCloseEditIEBodyDetails" class="btn btn-light" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button type="button" id="btnCloseFamilyMember" class="btn btn-light" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <div class="row">
            <div class="col-sm-12">
              <div class="form-group">
                ...
                <select class="form-control select2" id="relative_origin" required >
          ...
          <form id="frmOutsider">
            ...
            <div class="card-footer d-flex justify-content-between" style="margin-top:7px !important;">
              <button type="button" class="btn btn-block btn-outline-secondary mt-2" onclick="onResetOutsider()">RESET</button>
             &nbsp; <button type="submit" class="btn btn-block btn-danger">SUBMIT</button>
            </div>
          </form>
          <form id="frmStaff">
            ...
            <div class="card-footer d-flex justify-content-between" style="margin-top:7px !important;">
              <button type="button" class="btn btn-block btn-outline-secondary" onclick="onResetStaff()">RESET</button>
              <button type="submit" class="btn btn-block btn-danger">SUBMIT</button>
            </div>
          </form>
          <form id="frmStudent">
            ...
            <div class="card-footer d-flex justify-content-between" style="margin-top:7px !important;">
              <button type="button" class="btn btn-block btn-outline-secondary mt-2" onclick="onResetStudent()">RESET</button>
               &nbsp; <button type="submit" class="btn btn-block btn-danger">SUBMIT</button>
            </div>
          </form>
        </div>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button type="button" id="btnCloseAddWorkDetails" class="btn btn-light" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <form id="frmAddWorkDetails">
            ...
            <div class="card-footer d-flex justify-content-between" style="margin-top:7px !important;">
              <button type="button" class="btn btn-block btn-outline-secondary mt-2" onclick="onResetAddWorkDetails()">RESET</button>
               &nbsp; <button type="submit" class="btn btn-block btn-danger">SUBMIT</button>
            </div>
          </form>
        </div>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button type="button" id="btnCloseEditWorkDetails" class="btn btn-light" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button type="button" id="btnCloseAddVehicleInfo" class="btn btn-light" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <form id="frmSaveVehicleDetails">
            ...
            <div class="card-footer d-flex justify-content-between" style="margin-top:7px !important;">
              <button type="button" class="btn btn-block btn-outline-secondary mt-2" onclick="onResetAddVehicleInfo()">RESET</button>
               &nbsp; <button type="submit" class="btn btn-block btn-danger">SUBMIT</button>
            </div>
          </form>
        </div>
...
<script>
  ...
  $('#btnSavePhoto').click(function() {
    $('#mdlSavePhoto').modal('show');
  });
  $('#btnCloseSavePhoto').click(function() {
    $('#mdlSavePhoto').modal('hide');
  });

  $('#btnAddEducation').click(function() {
    $('#mdlAddEducation').modal('show');
  });
  $('#btnCloseAddEducation').click(function() {
    $('#mdlAddEducation').modal('hide');
  });

  $('#btnAddIEBodyDetails').click(function() {
    $('#mdlAddIEBodyDetails').modal('show');
  });
  $('#btnCloseAddIEBodyDetails').click(function() {
    $('#mdlAddIEBodyDetails').modal('hide');
  });
  $(document).on('ready', function(){
    $('.btnEditIEBodyDetails').click(function() {
      $('#mdlEditIEBodyDetails').modal('show');
    });
  });
  $('#btnCloseEditIEBodyDetails').click(function() {
    $('#mdlEditIEBodyDetails').modal('hide');
  });
  
  $('#btnFamilyMember').click(function() {
    $('#mdlFamilyMember').modal('show');
  });
  $('#btnCloseFamilyMember').click(function() {
    $('#mdlFamilyMember').modal('hide');
  });
  
  $('#btnAddWorkDetails').click(function() {
    $('#mdlAddWorkDetails').modal('show');
  });
  $('#btnCloseAddWorkDetails').click(function() {
    $('#mdlAddWorkDetails').modal('hide');
  });
  $('.btnEditWorkDetails').click(function() {
    $('#mdlEditWorkDetails').modal('show');
  });
  $('#btnCloseEditWorkDetails').click(function() {
    $('#mdlEditWorkDetails').modal('hide');
  });
  
  $('#btnAddVehicleInfo').click(function() {
    $('#mdlAddVehicleInfo').modal('show');
  });
  $('#btnCloseAddVehicleInfo').click(function() {
  ...
  if (windowObj.height() > windowObj.width()) {
    knobWidthHeight = Math.round(windowObj.width() * 0.09);
  } else {
    knobWidthHeight = Math.round(windowObj.height() * 0.09);
  }
  ...
  function onResetEditEducation() {
    ...
    if (doc_link != null && doc_link != '' && doc_link != 'null') {
      ...
      $('#e_doc').attr('data-default-file', "../app/data/documents/"+doc_name[2]);
      $('#e_doc').dropify();
    } else {
      $('#e_doc').addClass('dropify');
      $('#e_doc').dropify();
  ...
  // $("#start_date, #e_start_date, #end_date, #e_end_date").datepicker({ minDate: "-0D", maxDate: "+1Y", changeMonth:true, changeYear:true });
  $("#start_date").on('change', function()
  {
    $('#end_date').datepicker('option', 'minDate', new Date($("#start_date").val()));
  });

  $('#start_date, #e_start_date, #end_date, #e_end_date').daterangepicker(
  {
    singleDatePicker: true,
    showDropdowns: true,
    locale: {
  ...
  function sendStudentData() 
  {
    if (document.getElementById('ttlFamilyMember').innerHTML == 'Edit Family Member / Relative') 
    {
      ...
      colsole.log(allData);
      //gateway('STUDENT', 'ENTRY', 'UPDATE_FAMILYMEMBER_STUDENT', allData, onSuccess, onError);
    } 
    else 
    {
      let obj = {};
    ...
    if (rc.return_code) 
    {
      switch (rc.Page_key) 
      {
        case "getStaffProfileData":
          ...
          // console.log(rc.return_data['familyrelative_data']);
          ...
          if(personal_data.length>0)
          {
            if (personal_data[0]["Photo"] != null && personal_data[0]["Photo"] != '') {
              $('#v_photo').prop('src', "../app/data/PassportPhoto/" + personal_data[0]["Photo"]);
              $('#e_photo').addClass('dropify');
              $('#e_photo').attr('data-default-file', "../app/data/PassportPhoto/" + personal_data[0]["Photo"]);
              $('#e_photo').dropify();
            }
            else{
              $('#e_photo').addClass('dropify');
            ...
            if (personal_data[0]["JoinedDate0"] != null && personal_data[0]["JoinedDate0"] != '') {
              ...
              $('#e_doj').val(personal_data[0]["JoinedDate"]).trigger('change');
            }
            if (personal_data[0]["DOB0"] != null && personal_data[0]["DOB0"] != '') {
              $('#v_dob').prop('innerHTML', personal_data[0]["DOB0"]);
              $('#e_dob').val(personal_data[0]["DOB"]).trigger('change');
            }
          ...
          if (qualification_data.length > 0) {
            ...
            qualification_data.forEach(function(item_education) {
              ...
              if (item_education['YearOfPassing'] != null && item_education['YearOfPassing'] != '') {
                div_education += '<li style="list-style-type:none !important;">';
                div_education += '<div class="row bg-light m-1 p-2" style="border-left:2px solid #e9ecef !important;">';

                div_education += '<div class="col-sm-5" style="display:flex;align-items:center;">';
                div_education += '<div>';

                if (item_education["Specialisation"] != null && item_education["Specialisation"] != '' && item_education["Specialisation"] != '-' && item_education["Specialisation"] != '--') {
                  spc = ' <em>(' + item_education["Specialisation"] + ')</em>';
                }

                div_education += '<span class="text-muted" style="font-size:medium !important; text-transform:uppercase !important;">' + item_education["YearOfPassing"] + ' &mdash; ' + item_education["Qualification"] + spc + '</span></br>';
                ...
                if (board_university != '' && institute != '') {
                  ...
                  div_education += '<span>';
                  div_education += '<i class="fas fa-md fa-building text-muted m-1"></i>';
                  div_education += '<strong class="text-muted">' + div_bi + '</strong>';
                  div_education += '</span>';
                ...
                if (item_education["QualificationTypeID"] != 8) {
                  div_education += '<div class="col-sm-3" style="display:flex !important; justify-content:center !important; align-items:center !important;">';
                  div_education += '<h6 class="badge bg-danger rounded-pill p-2">' + division + '</h6>';
                  div_education += '</div>';
                } else {
                ...
                div_education += '<div class="col-sm-1" style="display:flex !important; justify-content:center !important; align-items:center !important; font-size:x-large !important;">';
                if (item_education["DocumentLink"] != null && item_education["DocumentLink"] != '') {

                  div_education += '<div>';
                  div_education += '<a class="text-danger" href=' + item_education["DocumentLink"] + ' target="_blank" title="VIEW DOCUMENT"><i class="fas fa-file-alt"></i></a>';
                  div_education += '</div>';
                }
                div_education += '</div>';

                if (item_education["QualificationTypeID"] != 8) {
                  div_education += '<div class="col-sm-2" style="display:flex !important; justify-content:center !important; align-items:center !important;">';
                  div_education += '<div>';
                  div_education += '<input type="text" value="' + percentage + '" class="Chart" id="q_percentage" />';
                  div_education += '</div>';
                  div_education += '</div>';
                } else {
                  div_education += '<div class="col-sm-2" style="display:flex !important; justify-content:center !important; align-items:center !important;">';
                ...
                div_education += '<div class="col-sm-1" style="display:flex !important; justify-content:center !important; align-items:center !important;">';
                div_education += '<div>';
            ...
            div_education += '<div style="text-align:center !important;">';
            div_education += '<h4 class="text-muted"><i class="fas fa-exclamation-triangle text-danger m-1"></i>Education Details not found !!</h4>';
            div_education += '</div>';
          ...
          if (eb_len > 0)
          {
            ...
            for(var i=0; i<eb_len; i++)
            {
              ...
              if(iebody_data[i]['Type']=='1')
              {
                ...
                {
                  div_iebody += '<div class="col-11"><strong class="badge bg-danger rounded-pill m-2" style="font-weight:500; font-size:small !important;">INTERNAL</strong><strong class="text-muted">'+iebody_data[i]['Title']+' &mdash; </strong><span>'+iebody_data[i]['Role']+'</span><span style="float:right !important; font-style:italic; font-size:small;">(Date: '+iebody_data[i]['StartDate1']+' - '+iebody_data[i]['EndDate1']+')</span></div>';
                }
                else {
                  div_iebody += '<div class="col-11"><strong class="badge bg-danger rounded-pill m-2" style="font-weight:500; font-size:small !important;">INTERNAL</strong><strong class="text-muted">'+iebody_data[i]['Title']+' &mdash; </strong><span>'+iebody_data[i]['Role']+'</span><span style="float:right !important; font-style:italic; font-size:small;">(Date: '+iebody_data[i]['StartDate1']+' - Present)</span></div>';
                }
              }
              else 
              {
                if (iebody_data[i]['Status'] == '0') 
                {
                  div_iebody += '<div class="col-11"><strong class="badge bg-danger rounded-pill m-2" style="font-weight:500; font-size:small !important;">EXTERNAL</strong><strong class="text-muted">'+iebody_data[i]['Title']+' &mdash; </strong><span>'+iebody_data[i]['Role']+'</span><span style="float:right !important; font-style:italic; font-size:small;">(Date: '+iebody_data[i]['StartDate1']+' - '+iebody_data[i]['EndDate1']+')</span></div>';
                }
                else {
                  div_iebody += '<div class="col-11"><strong class="badge bg-danger rounded-pill m-2" style="font-weight:500; font-size:small !important;">EXTERNAL</strong><strong class="text-muted">'+iebody_data[i]['Title']+' &mdash; </strong><span>'+iebody_data[i]['Role']+'</span><span style="float:right !important; font-style:italic; font-size:small;">(Date: '+iebody_data[i]['StartDate1']+' - Present)</span></div>';
                }
              }
              div_iebody += '<div class="col-1"><button class="btn btn-default text-danger no-media btnCustom1 float-sm-right btnEditIEBodyDetails" data-toggle="modal" data-target="#mdlEditIEBodyDetails" title="EDIT" data-id="'+iebody_data[i]['ID']+'" data-type="'+iebody_data[i]['Type']+'" data-title="'+iebody_data[i]['Title']+'" data-role="'+iebody_data[i]['Role']+'" data-sdate="'+iebody_data[i]['StartDate']+'" data-edate="'+iebody_data[i]['EndDate']+'" data-status="'+iebody_data[i]['Status']+'"><i class="fas fa-edit"></i></button></div>';
            ...
            div_iebody += '<div style="text-align:center !important;">';
            div_iebody += '<h4 class="text-muted"><i class="fas fa-exclamation-triangle text-danger m-1"></i>Internal/External Body Details not found !!</h4>';
            div_iebody += '</div>';
          }
          ...
          if (familyrelative_data.length > 0) {
            ...
            familyrelative_data.forEach(function(item) {
              ...
              if (item['IsGuardian'] == '1')
                div_family += '<div class="card" style="background-color:#fff1f1 !important; display:block !important; padding:0 !important;">';
              else
                div_family += '<div class="card" style="background-color:#f8f9fa !important; display:block !important; padding:0 !important;">';

              div_family += '<ul class="fa-ul text-muted" style="margin-bottom:0 !important; margin-left:1.6rem !important; padding:0.5rem !important;">';
              ...
              div_family += '</ul>';
              div_family += '<a onclick="editFamilyMember(' + item['RelationID'] + ')" data-toggle="modal" data-target="#mdlFamilyMember" class="btn btn-default text-danger btnCustom btnEdit no-media" title="EDIT"><i class="fas fa-edit"></i></a>';
              div_family += '<span class="div_relation bg-danger">' + item['RelationTitle'] + '</span>';
              div_family += '</div>';
              div_family += '</div>';
            });
          } 
            ...
            div_family += '<div style="text-align:center !important;">';
            div_family += '<h4 class="text-muted"><i class="fas fa-exclamation-triangle text-danger m-1"></i>Family Members not found !!</h4>';
            div_family += '</div>';
          }
          $('#div_family').empty();
          ...
          if (eb_len > 0)
          {
            ...
            for(var i=0; i<eb_len; i++)
            {
              ...
              {
                div_workdetails += '<div class="col-11"><strong class="text-muted">'+work_data[i]['Organisation']+'</strong><span> &mdash; '+work_data[i]['Designation']+'</span><span style="float:right !important; font-style:italic; font-size:small;">(Date: '+work_data[i]['StartDate1']+' - '+work_data[i]['EndDate1']+')</span></div>';
              }
              else {
                div_workdetails += '<div class="col-11"><strong class="text-muted">'+work_data[i]['Organisation']+'</strong><span> &mdash; '+work_data[i]['Designation']+'</span><span style="float:right !important; font-style:italic; font-size:small;">(Date: '+work_data[i]['StartDate1']+' - Present)</span></div>';
              }
            ...
            div_workdetails += '<div style="text-align:center !important;">';
            div_workdetails += '<h4 class="text-muted"><i class="fas fa-exclamation-triangle text-danger m-1"></i>Work Details not found !!</h4>';
            div_workdetails += '</div>';
          }
          ...
          if (vehicle_data.length > 0) {
            ...
            vehicle_data.forEach(function(item) 
            {
              ...
              div_vehicle += '<div class="card bg-light">';
              div_vehicle += '<a id="edit_btn' + serial_number + '" onclick="editVehicleInfo(' + serial_number + ')" data-toggle="modal" data-target="#mdlEditVehicleInfo" data-vehicle_details_id="' + item['VehicleDetailsID'] + '" data-vehicle_type_id="' + item['VehicleTypeID'] + '" data-vehicle_brand="' + item['VehicleBrand'] + '" data-vehicle_model="' + item['VehicleModel'] + '" data-vehicle_color="' + item['VehicleColor'] + '" data-vehicle_number="' + item['VehicleNumber'] + '" data-is_vehicle_owner="' + item['IsVehicleOwner'] + '" data-vehicle_owner_name="' + item['VehicleOwnerName'] + '" style="display:flex !important; justify-content:right !important; align-items:right !important;" class="btn btnCustom1 btnEdit no-media" title="UPDATE"><i class="fas fa-edit"></i></a>';
              div_vehicle += '<div class="row p-2">';
              div_vehicle += '<div class="col-sm-8">';
              div_vehicle += '<strong class="text-muted">' + item['VehicleNumber'] + '</strong></br>';
              div_vehicle += '<span class="text-muted">' + item['VehicleBrand'] + ' - ' + item['VehicleModel'] + ' (' + item['VehicleColor'] + ')</span>';
              div_vehicle += '</div>';
              if (item['VehicleTypeID'] == '1')
                div_vehicle += '<div class="col-sm-4" style="font-size:xx-large !important; display:flex !important; justify-content:right !important; align-items:right !important;"><i class="fas fa-car bx-tada"></i></div>';
              else
                div_vehicle += '<div class="col-sm-4" style="font-size:xx-large !important; display:flex !important; justify-content:right !important; align-items:right !important;"><i class="fas fa-motorcycle bx-tada"></i></div>';
              div_vehicle += '</div>';
              div_vehicle += '<div class="card-footer text-center"><span>Registered on ' + vehicle_owner + ' Name</span></div>';
              div_vehicle += '</div>';
              div_vehicle += '</div>';
              serial_number++;
            });
            ...
            div_vehicle += '<div style="text-align:center !important;">';
            div_vehicle += '<h4 class="text-muted"><i class="fas fa-exclamation-triangle text-danger m-1"></i>Vehicle Info not found !!</h4>';
            div_vehicle += '</div>';
          }
