                ...
                <div class="row">
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-12" style="display:flex; align-items:center;">
                    <div>
                      ...
                      <h5 id="v_department" class="text-white">-Department-</h6>
                    </div>
                  </div>
                ...
                <div style="display:flex !important; justify-content:space-around !important;">
                  <div>
                    <div class="description-block">
                      <h5 id="v_age" class="text-danger text-center">-</h5>
                      <h5 class="text-white text-center">AGE</h5>
                    </div>
                  </div>
                  <div>
                    <div class="description-block">
                      <h5 id="v_bloodgroup" class="text-danger text-center">-</h5>
                      <h5 class="text-white text-center">BLOOD GROUP</h5>
                    </div>
                  </div>
                  <div>
                    <div class="description-block">
                      <h5 id="v_yoe" class="text-danger text-center">-</h5>
          ...
          <div class="col-sm-12" id="div_additionaldetails_section">
            <div class="card">
              <div class="card-body" id="div_additionaldetails">
                <p class="card-title custom_card-title">MY ADDITIONAL DETAILS</p>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="frmAddEducationInformation">
            ...
            <div class="card-footer d-flex justify-content-between" style="margin-top:7px !important;">
              <button type="button" class="btn btn-block btn-outline-secondary" onclick="onResetAddEducation()">RESET</button>
              <button type="submit" class="btn btn-block btn-danger">SUBMIT</button>
            </div>
          </form>
        </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form id="frmOutsider">
            ...
            <div class="card-footer d-flex justify-content-between" style="margin-top:7px !important;">
              <button type="button" class="btn btn-block btn-outline-secondary" onclick="onResetOutsider()">RESET</button>
              <button type="submit" class="btn btn-block btn-danger">SUBMIT</button>
            </div>
          </form>
          <form id="frmStaff">
          ...
          <form id="frmStudent">
            ...
            <div class="card-footer d-flex justify-content-between" style="margin-top:7px !important;">
              <button type="button" class="btn btn-block btn-outline-secondary" onclick="onResetStudent()">RESET</button>
              <button type="submit" class="btn btn-block btn-danger">SUBMIT</button>
            </div>
          </form>
        </div>
