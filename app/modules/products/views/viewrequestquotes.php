                            ...
                            <table id="table" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Business/ Organization Name </th>
                                        <th scope="col">Description</th>
                                        <th scope="col">RequiredService</th>
...
<script>
    $(function() {
        //getProducts();  
        getviewirequestquotes();
    });


    function getviewirequestquotes() {
        var obj = new Object();
        obj.Module = "Products";
        obj.Page_key = "getviewirequestquotes";
        var json = new Object();
        obj.JSON = json;
        TransportCall(obj);
    }
    ...
    function loaddata(data) {
        ...
        if (data.length == 0) {
            ...
            for (let i = 0; i < data.length; i++) {
                ...
                text += '<td> ' + data[i].RequiredService+ '</td>';
