                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title">View Leads</h4>
                            ...
                            <table id="table" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">SchoolGroupName</th>
...
<script>
    ...
    //     TransportCall(obj);
    // }
    function getProductViewLeads() {
        var obj = new Object();
        obj.Module = "Products";
        obj.Page_key = "getProductViewLeads";
        var json = new Object();
        obj.JSON = json;
        TransportCall(obj);
    }
